...
namespace UnitTest.AzureDevOpsDemo
{
    ...
    {       
        ...
        public async void Test_Employees_Put()
        {
            ...
            Employee updateEmp = new Employee() { Id = updatedId, Name="AlexTest", Address="Oslo", Email="alex@test.com", SalaryGrade = 60, DOB = Convert.ToDateTime("1991-01-21"), Updated = DateTime.Now };
